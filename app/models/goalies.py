...
class GoalieWeekCard(Base):
    """Per-week goalie cards (dbt-managed api.goalies_week_page).

    Same columns as GoalieCard plus week_id.
    Grain: (season_id, league_id, game_type_id, week_id, player_id).
    """

    __tablename__ = "goalies_week_page"
    __table_args__ = {"schema": "api"}
