...
from sqlalchemy import TIMESTAMP, BigInteger, Integer, Numeric, String, Text
...
class PlayerWeekCard(Base):
    """Per-week player cards (dbt-managed api.players_week_page).

    Same columns as PlayerCard plus week_id.
    Grain: (season_id, league_id, game_type_id, week_id, player_id, pos_group).
    """

    __tablename__ = "players_week_page"
    __table_args__ = {"schema": "api"}
