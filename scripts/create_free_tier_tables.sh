#!/bin/bash
# ============================================
# Create Free Tier Tables Script
# ============================================
# Run this ONCE to create the _free snapshot tables.
# ============================================
...
echo "============================================"
echo "Creating Free Tier Tables"
echo "============================================"
echo "Host: $DB_HOST"
...
# Run the SQL script
psql -h "$DB_HOST" -p "$DB_PORT" -U "$DB_USER" -d "$DB_NAME" -f "$SCRIPT_DIR/create_free_tier_tables.sql"

echo "============================================"
echo "Tables created! Now populating with initial data..."
echo "============================================"

# Populate the tables with current data
